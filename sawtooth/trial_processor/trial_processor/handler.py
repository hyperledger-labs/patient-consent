...
import trial_processor.trial_common.helper as helper
from trial_processor.payload import TrialPayload
from trial_processor.state import TrialState
...
class TrialTransactionHandler(TransactionHandler):
    ...
    def apply(self, transaction, context):
        try:
            ...
            payload = TrialPayload(payload=transaction.payload)
